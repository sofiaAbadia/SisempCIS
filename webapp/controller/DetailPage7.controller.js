sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.cis.controller.DetailPage7", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("DetailPage7").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			var oView = this.getView();
					...
					if (sap.ui.Device.system.phone) {
						...
						if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
							...
							oPage.attachNavButtonPress(function() {
								this.oRouter.navTo("MasterPage3", {}, true);
							}.bind(this));
						}
					}
				}.bind(this)
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_IconTabBar_Page_0-content-build_simple_Table-1637521638016-pujuwgi8bq5fpsqmffnr39119_S9",
				"groups": ["items"]
			}];
